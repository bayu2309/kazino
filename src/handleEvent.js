...
export default class HandleEvent {
  ...
  _handling(event) {
    ...
    if(event.type === "message") {
      ...
      if (msgText.includes("kazuino") == false) return Promise.resolve(null);
      ...
      if(msgText.includes("kazuino apa itu")) {
      ...
      if(msgText.includes("kazuino cari gambar")) {
      ...
      if(msgText.includes("kazuino cari video")) {
      ...
      if(msgText.includes("kazuino stalk")) {
        let keyword = msgText.substr(12);
      ...
      if(msgText.includes("kazuino terjemahkan")) {
      ...
      if(msgText.includes("kazuino cari lokasi")) {
      ...
      if(msgText.includes("kazuino tulis")) {
        let keyword = msgText.substr(12);
...
//       }
      ...
      if(msgText.includes("kazuino download musik")) {
      ...
      if(msgText.includes("kazuino lovemeter")) {
      ...
      if (msgText === "kazuino anime quotes") {
      ...
      if(msgText.includes("kazuino osu")) {
      ...
      if (msgText === "bye kazuino") {
        return client.replyMessage(replyToken, [ Wrapper.replyText("Bye - Bye"), Wrapper.replyImg(constAPI.KAZUINOLEAVEIMG_URL, constAPI.KAZUINOLEAVEIMG_URL) ]).then(result => {
          if (source === "room") {
